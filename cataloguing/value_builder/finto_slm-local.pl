...
//<![CDATA[
	...
	function formatSelection$function_name (data) {
        ...
        if(data.id !== '') {
            ...
            fieldarray[fieldarray.length-1].value="7";
            ...
            fieldarray[fieldarray.length-1].value=data.uri;
			...
			fieldarray[fieldarray.length-1].value=data.vocab+ "/$langcode";
	...
	function click$function_name(event) {
		...
		\$("#"+tag).on("input",(function(){
			...
			fieldarray[fieldarray.length-1].value="local";
